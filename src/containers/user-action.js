            ...
            return (
                <form id='signup' onSubmit={(e) => this.handleSubmit(e, 'signup')}>
                    ...
                    <div>
                        ...
                        <input type='text' id='username' value={signup_user.username} onChange={e => this.handleChange(e, 'signup', 'username')} />
                    </div>
                    <div>
                        <label htmlFor='password'>Password: </label>
                        <input type='password' id='password' value={signup_user.password} onChange={e => this.handleChange(e, 'signup', 'password')} />
                    </div>
        ...
        const renderLogin = () => {
            return (
                <form id='login' onSubmit={(e) => this.handleSubmit(e, 'login')}>
                    ...
                    <div>
                        <label htmlFor='username'>Username: </label>
                        <input type='text' id='username' value={login_user.username} onChange={e => this.handleChange(e, 'login', 'username')} />
                    </div>
                    <div>
                        <label htmlFor='password'>Password: </label>
                        <input type='password' id='password' value={login_user.password} onChange={e => this.handleChange(e, 'login', 'password')} />
                    </div>
                    <button type='submit' disabled={this.isSubmitDisabled(errors)}>Login</button>
...
export default connect(mapStateToProps, { signup, login, logout })(UserAction)
