      ...
      return (
        <div>
          ...
          <div id="post-body">
            ...
            <p className="date">
              {isEdit ? `Edited: ${date}` : `Created: ${date}`}
            </p>
            <p>{content}</p>
          </div>
        </div>
        ...
        <div>
          ...
          <form onSubmit={handleSubmit(this.onSubmit)}>
            ...
            <div id="save-cancel">
              ...
              <button type="clear" onClick={this.props.reset}>
                Reset
              </button>
...
const mapStateToProps = (state, props) => {
  ...
  return {
    ...
    } //reduxForm uses it not the component
  };
};
...
const validate = (values, props) => {
  ...
  const errors = {
    title:
      !values.title || values.title === props.initialValues.title
        ? "Enter a title"
        : "",
...
export default connect(
  mapStateToProps,
  { deletePost, updatePost, generateDate }
)(ReduxFormComponent);
