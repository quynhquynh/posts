...
const Form = ({props, handleChange}) => (
    <div>
        <div>
            ...
            <input id='title' name='title' type='text' value={props.title} onChange={e => handleChange(e, 'title')} />
        </div>
        <div>
        ...
        <div>
            ...
            <textarea id='content' name='content' value={props.content} onChange={e => handleChange(e, 'content')} type='text' ></textarea>
        </div>
    </div>
)
